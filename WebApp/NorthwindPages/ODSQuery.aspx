...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <div class="row col-md-12">
        <div class="alert alert-warning">
            <blockquote style="font-style: italic">
                ...
                and formatting. All searches will be done using ObjectDataSource. The code behind will demonstrate accessing columns
                on the GridView
            </blockquote>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <asp:GridView ID="ProductSelectionList" runat="server" OnSelectedIndexChanged="ProductSelectionList_SelectedIndexChanged" AutoGenerateColumns="False" CssClass="table" GridLines="Horizontal" BorderStyle="None" DataSourceID="ProductSelectionListODS" AllowPaging="True">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Size">
                        <ItemTemplate>
                           <%-- <asp:Label ID="Label11" runat="server" Text='<%# Eval("QuantityPerUnit") %>'></asp:Label>--%>
                            <asp:DropDownList ID="CategoryIDList" runat="server" Width="200px" DataSourceID="CategoryListODS" DataTextField="CategoryName" DataValueField="CategoryID" SelectedValue='<%# Eval("CategoryID") %>'>
        ...
        <asp:ObjectDataSource ID="ProductSelectionListODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Product_GetByPartialName" TypeName="NorthwindSystem.BLL.ProductController">
            <SelectParameters>
                <asp:ControlParameter ControlID="SearchPartialName" PropertyName="Text" DefaultValue="xzyxzqknyxk" Name="partialname" Type="String"></asp:ControlParameter>
            </SelectParameters>
