...
namespace NorthwindSystem.BLL
{
    ...
    public class ProductController
    {
        ...
        // this method is not an extension like list or get above
        ...
        public List<Product> Product_GetByPartialName(string partialname)
        {
            using (var context = new NorthwindContext())
            {
                ...
                // this data set can be converted to List<T> by using
                //      .ToList()

                // the dbset is not used
                // the method Database.SQLQeury<T>() is used to execute the database query
                ...
                //  b) a list of SqlParameter() instance(s); each instance representing 
                //      a parameter in the sql procedure call
                //  the instance has two entries, the parameter name and the value
                //      for the parameter
        ...
        // The delete methods will NOW be overloaded
